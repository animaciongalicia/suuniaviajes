        ...
        <div className="mx-auto max-w-3xl">
          <AnimateOnScroll>
            ...
            <div className="mt-8 space-y-6 text-gray-600 leading-relaxed">
              ...
              <p>
                Organizamos <Link href="/excursiones-privadas-galicia" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">excursiones privadas de un día a Fisterra y Muxía</Link>, <Link href="/grandes-rutas-galicia" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">rutas de varios días por la costa atlántica</Link> y experiencias <Link href="/galicia-premium" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">premium</Link> con alojamientos exclusivos y accesos que no están al alcance del turismo convencional. La Costa da Morte se combina perfectamente con las <Link href="/guias/rias-baixas" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">Rías Baixas</Link> y con una parada gastronómica en alguno de los <Link href="/guias/restaurantes-michelin-galicia" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">restaurantes con estrella Michelin de la zona</Link>. Consulta también <Link href="/guias/cuando-viajar-galicia" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">cuándo es la mejor época para viajar</Link>.
              </p>
            </div>
          </AnimateOnScroll>
        </div>
