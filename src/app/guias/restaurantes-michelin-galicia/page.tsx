        ...
        <div className="mx-auto max-w-3xl">
          <AnimateOnScroll>
            ...
            <div className="mt-8 space-y-6 text-gray-600 leading-relaxed">
              <p>
                Organizar una ruta gastronómica por los Michelin de Galicia no es solo reservar mesa. Es diseñar un itinerario que combine los restaurantes con visitas a bodegas, mercados de abastos, lonjas de pescado y experiencias que den contexto a lo que se come en cada sitio. Que la <Link href="/guias/vinos-denominaciones-origen-galicia" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">ruta del vino en Rías Baixas</Link> prepare el paladar para la cena en Culler de Pau. Que la visita a la lonja de A Coruña al amanecer tenga sentido antes de comer en Árbore da Veira. Que una jornada en la <Link href="/guias/ribeira-sacra" className="text-atlantic-700 underline decoration-atlantic-300 underline-offset-2 hover:decoration-atlantic-600">Ribeira Sacra</Link> entre viñedos y cañones anticipe la cena en una mesa con estrella.
              </p>
              <p>
          ...
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              },
              {
                "@type": "ListItem",
                position: 3,
                name: "Restaurantes Michelin en Galicia",
              },
            ],
          }),
        }}
