            ...
            <div className="mt-6 grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {[
                ...
                <div key={i} className="flex gap-3">
                  <svg className="mt-1 h-5 w-5 flex-shrink-0 text-atlantic-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-3">
            {experiencias.map((exp) => (
              <Link
                key={exp.title}
                href={exp.href}
                className="group overflow-hidden rounded-2xl bg-white shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1"
              >
