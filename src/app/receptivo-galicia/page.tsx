          ...
          <AnimateOnScroll>
            <div className="grid items-start gap-8 md:grid-cols-2">
              ...
              <div className="relative h-64 overflow-hidden rounded-2xl md:h-80">
                <Image src="/images/parador-baiona-top-premium.jpg" alt="Parador de Baiona, servicio receptivo premium en Galicia" fill className="object-cover" sizes="(max-width: 768px) 100vw, 50vw" />
              </div>
            </div>
          </AnimateOnScroll>
        </div>
