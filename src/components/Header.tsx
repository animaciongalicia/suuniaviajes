...
const navigation = [
  ...
  { name: "Incentivos Empresas", href: "/incentivos-empresa-galicia" },
  ...
  return (
    <header className="fixed top-0 z-50 w-full border-b border-gray-100 bg-white/95 backdrop-blur-md">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3 lg:px-8">
        <Link href="/" className="flex items-center gap-2.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-atlantic-600 focus-visible:ring-offset-2 rounded-md">
          <Image
        ...
        <div className="hidden items-center gap-5 lg:flex">
          {navigation.map((item) => (
            <Link
              key={item.name}
              href={item.href}
              className="text-sm font-medium text-gray-600 transition-colors hover:text-atlantic-700 focus-visible:outline-none focus-visible:text-atlantic-700 focus-visible:underline focus-visible:underline-offset-4"
            >
              {item.name}
            </Link>
          ))}
          <a
            ...
            className="btn-whatsapp focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-600 focus-visible:ring-offset-2"
          >
        ...
        >
          <svg aria-hidden="true" className="h-6 w-6 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            {mobileOpen ? (
