        ...
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm leading-relaxed text-gray-500">
              Suunia – Agencia receptiva en Galicia especializada en viajes,
              experiencias y logística para grupos y empresas.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3 text-sm text-gray-500">
              <li>
                <a href="tel:+34678288284" className="hover:text-atlantic-700">
                  +34 678 288 284
                </a>
              </li>
              <li>
